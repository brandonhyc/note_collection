...
Overlay.prototype.setHeight = function(val) {
    ...
    //   Overlay.prototype.setWidth = function (val) {
    //       var el = document.getElementsByClassName("overlay-inner")[0] asas HTMLElement;
    //       el.style.width = val + "px";
    //       el.style.marginLeft = -val / 2 + "px";

    //       return this;
    //   };

    //   Overlay.prototype.setHeight = function (val) {
    //       var el = document.getElementsByClassName("overlay-inner")[0] as HTMLElement;
    //       el.style.height = val + "px";
    //       el.style.marginTop = -val / 2 + "px";
