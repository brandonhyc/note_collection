...
### Hibernate 
Hibernate takes care of mapping Java classes to database tables using XML files. Abstract away the unfamiliar SQL types and provide us to work around familiar Java Objects.
